    ...
    return LayoutBuilder(
      builder: (context, constraints) {
        ...
        for (int i = 0; i < moodData.length; i++) {
          ...
          // generate random background colors of blue
          Color color = Color.fromARGB(255, 0, 0, random.nextInt(200),).withValues(alpha: 0.8);
            ...
            Positioned(
              ...
              child: ValueListenableBuilder<String?>(
                ...
                builder: (context, selectedMood, child) {
                  ...
                  final Color backgroundColor = isSelected ? const Color(0xFF0000FF) : const Color.fromARGB(255, 182, 121, 214).withValues(alpha: 0.1);
                  

                  return GestureDetector(
                    onTap: (){
                      _selectedMood.value = isSelected ? null : moodData[i]['mood'];
                      _selectedMoodImage.value = isSelected ? null : moodData[i]['image'];
                      widget.onMoodSelected(_selectedMood.value, _selectedMoodImage.value);
                    },
                    child: Container(
                      ...
                      child: Container(
                        ...
                        height: size, 
                        decoration: BoxDecoration(
                          color: isSelected ? const Color.fromARGB(255, 182, 121, 214).withValues(alpha: 0.1) : color,
                          shape: BoxShape.circle,
                        ),
                        child: Image.asset(
                          moodData[i]['image']!,
